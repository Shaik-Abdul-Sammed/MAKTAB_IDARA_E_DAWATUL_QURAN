...
class BehaviorLogAddScreen extends StatefulWidget {
  const BehaviorLogAddScreen({super.key});

  @override
  State<BehaviorLogAddScreen> createState() => _BehaviorLogAddScreenState();
}

class _BehaviorLogAddScreenState extends State<BehaviorLogAddScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Log Behavior Event Details',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF004D40)),
                ),
                const SizedBox(height: 8),
                const Text(
                  'Record student behavior alerts (academic achievement, discipline).',
