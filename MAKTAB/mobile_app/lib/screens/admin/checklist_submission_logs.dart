...
class ChecklistSubmissionLogsScreen extends StatefulWidget {
  const ChecklistSubmissionLogsScreen({super.key});

  @override
  State<ChecklistSubmissionLogsScreen> createState() => _ChecklistSubmissionLogsScreenState();
}

class _ChecklistSubmissionLogsScreenState extends State<ChecklistSubmissionLogsScreen> {
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  leading: const CircleAvatar(
                                    ...
                                    child: Icon(Icons.history_edu, size: 18),
                                  ),
