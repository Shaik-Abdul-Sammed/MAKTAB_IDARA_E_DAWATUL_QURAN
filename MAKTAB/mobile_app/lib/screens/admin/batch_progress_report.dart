...
class BatchProgressReportScreen extends StatefulWidget {
  const BatchProgressReportScreen({super.key});

  @override
  State<BatchProgressReportScreen> createState() => _BatchProgressReportScreenState();
}

class _BatchProgressReportScreenState extends State<BatchProgressReportScreen> {
  ...
  Future<void> _loadRecords() async {
    ...
    final records = await repo.getAllProgress();
        if (mounted) {
            setState(() {
                _items = records;
                _isLoading = false;
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text('Surah: ${item.surah}', style: const TextStyle(fontWeight: FontWeight.bold)),
                                  subtitle: Text('Student ID: ${item.studentId} | Ayahs: ${item.ayahFrom} - ${item.ayahTo}'),
