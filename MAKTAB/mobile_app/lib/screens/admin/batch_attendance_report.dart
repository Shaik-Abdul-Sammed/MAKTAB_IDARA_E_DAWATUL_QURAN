...
class BatchAttendanceReportScreen extends StatefulWidget {
  const BatchAttendanceReportScreen({super.key});

  @override
  State<BatchAttendanceReportScreen> createState() => _BatchAttendanceReportScreenState();
}

class _BatchAttendanceReportScreenState extends State<BatchAttendanceReportScreen> {
  ...
  Widget build(BuildContext context) {
    final filteredItems = _items.where((item) => item.studentId.toString().contains(_searchQuery)).toList();

    return Scaffold(
      backgroundColor: const Color(0xFFF9FBE7), // Cream background
      appBar: AppBar(
        title: const Text(
          'View Batch Attendance Sheet',
