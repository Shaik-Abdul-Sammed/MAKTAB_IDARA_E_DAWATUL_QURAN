...
class AttendanceSummaryReportScreen extends StatelessWidget {
  const AttendanceSummaryReportScreen({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Analyze monthly attendance rates and average present counts.',
