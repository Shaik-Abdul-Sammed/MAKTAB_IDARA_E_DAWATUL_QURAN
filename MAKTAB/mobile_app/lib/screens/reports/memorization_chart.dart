...
class MemorizationChartScreen extends StatelessWidget {
  const MemorizationChartScreen({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Visualize student memorization velocity over time.',
