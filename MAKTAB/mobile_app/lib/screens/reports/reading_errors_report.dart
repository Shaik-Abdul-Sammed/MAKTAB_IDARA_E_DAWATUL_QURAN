...
class ReadingErrorsReportScreen extends StatelessWidget {
  const ReadingErrorsReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Nazira/Tajweed Common Error Logs',
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Analyze makhraj and Tajweed mistakes logged during lessons.',
