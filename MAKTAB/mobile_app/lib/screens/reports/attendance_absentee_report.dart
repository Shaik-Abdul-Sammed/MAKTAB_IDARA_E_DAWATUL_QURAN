...
class AttendanceAbsenteeReportScreen extends StatelessWidget {
  const AttendanceAbsenteeReportScreen({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Identify students with high absence rates for follow-ups.',
