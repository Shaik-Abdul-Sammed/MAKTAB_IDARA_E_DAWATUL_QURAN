...
class SettingsDbToolsScreen extends StatefulWidget {
  const SettingsDbToolsScreen({super.key});

  @override
  State<SettingsDbToolsScreen> createState() => _SettingsDbToolsScreenState();
}

class _SettingsDbToolsScreenState extends State<SettingsDbToolsScreen> {
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'Wipe test data, rebuild database indexes, or compact tables.',
