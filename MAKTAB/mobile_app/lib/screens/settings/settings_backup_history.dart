...
class SettingsBackupHistoryScreen extends StatefulWidget {
  const SettingsBackupHistoryScreen({super.key});

  @override
  State<SettingsBackupHistoryScreen> createState() => _SettingsBackupHistoryScreenState();
}

class _SettingsBackupHistoryScreenState extends State<SettingsBackupHistoryScreen> {
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'Verify dates, sizes, and integrity of previous database backups.',
