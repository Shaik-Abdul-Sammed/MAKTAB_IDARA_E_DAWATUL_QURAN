...
class FaceAuthScanScreen extends StatefulWidget {
  const FaceAuthScanScreen({super.key});

  @override
  State<FaceAuthScanScreen> createState() => _FaceAuthScanScreenState();
}

class _FaceAuthScanScreenState extends State<FaceAuthScanScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Scan Face Verification',
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFFFFD700)),
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: 12),
              const Text(
                'Scanning local facial geometry traits to confirm teacher session identity.',
