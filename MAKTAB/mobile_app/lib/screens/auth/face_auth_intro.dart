...
class FaceAuthIntroScreen extends StatefulWidget {
  const FaceAuthIntroScreen({super.key});

  @override
  State<FaceAuthIntroScreen> createState() => _FaceAuthIntroScreenState();
}

class _FaceAuthIntroScreenState extends State<FaceAuthIntroScreen> {
  String _pinCode = '';
