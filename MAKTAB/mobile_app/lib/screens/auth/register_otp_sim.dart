...
class RegisterOtpSimScreen extends StatefulWidget {
  const RegisterOtpSimScreen({super.key});

  @override
  State<RegisterOtpSimScreen> createState() => _RegisterOtpSimScreenState();
}

class _RegisterOtpSimScreenState extends State<RegisterOtpSimScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Simulated offline verification protocol via master registration code check.',
