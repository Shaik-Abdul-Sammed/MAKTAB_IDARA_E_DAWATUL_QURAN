...
class RegisterPinConfirmScreen extends StatefulWidget {
  const RegisterPinConfirmScreen({super.key});

  @override
  State<RegisterPinConfirmScreen> createState() => _RegisterPinConfirmScreenState();
}

class _RegisterPinConfirmScreenState extends State<RegisterPinConfirmScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Confirm your security access code to complete setup.',
