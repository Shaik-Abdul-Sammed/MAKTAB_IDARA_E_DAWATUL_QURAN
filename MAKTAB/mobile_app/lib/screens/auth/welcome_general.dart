...
class WelcomeGeneralScreen extends StatefulWidget {
  const WelcomeGeneralScreen({super.key});

  @override
  State<WelcomeGeneralScreen> createState() => _WelcomeGeneralScreenState();
}

class _WelcomeGeneralScreenState extends State<WelcomeGeneralScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'General Welcome Onboarding',
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFFFFD700)),
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: 12),
              const Text(
                'Explore the offline-first Islamic management platform for teaching, progress, and daily audit.',
