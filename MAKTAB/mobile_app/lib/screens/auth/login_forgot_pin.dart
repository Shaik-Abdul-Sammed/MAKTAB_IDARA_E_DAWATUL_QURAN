...
class LoginForgotPinScreen extends StatefulWidget {
  const LoginForgotPinScreen({super.key});

  @override
  State<LoginForgotPinScreen> createState() => _LoginForgotPinScreenState();
}

class _LoginForgotPinScreenState extends State<LoginForgotPinScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Reset security credentials using master recovery code key.',
