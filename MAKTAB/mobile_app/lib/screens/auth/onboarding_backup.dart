...
class OnboardingBackupScreen extends StatefulWidget {
  const OnboardingBackupScreen({super.key});

  @override
  State<OnboardingBackupScreen> createState() => _OnboardingBackupScreenState();
}

class _OnboardingBackupScreenState extends State<OnboardingBackupScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Safeguard your data by exporting encrypted zip backups to external storage.',
