...
class FaceAuthSuccessScreen extends StatefulWidget {
  const FaceAuthSuccessScreen({super.key});

  @override
  State<FaceAuthSuccessScreen> createState() => _FaceAuthSuccessScreenState();
}

class _FaceAuthSuccessScreenState extends State<FaceAuthSuccessScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Teacher identity validated successfully. Loading workspace...',
