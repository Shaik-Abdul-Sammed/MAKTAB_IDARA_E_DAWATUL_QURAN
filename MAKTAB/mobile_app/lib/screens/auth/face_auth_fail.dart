...
class FaceAuthFailScreen extends StatefulWidget {
  const FaceAuthFailScreen({super.key});

  @override
  State<FaceAuthFailScreen> createState() => _FaceAuthFailScreenState();
}

class _FaceAuthFailScreenState extends State<FaceAuthFailScreen> {
  String _pinCode = '';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Face authentication verification failed. Try manual backup recovery.',
