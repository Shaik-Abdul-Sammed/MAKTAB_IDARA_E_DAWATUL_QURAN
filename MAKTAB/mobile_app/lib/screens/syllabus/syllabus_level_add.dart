...
class SyllabusLevelAddScreen extends StatefulWidget {
  const SyllabusLevelAddScreen({super.key});

  @override
  State<SyllabusLevelAddScreen> createState() => _SyllabusLevelAddScreenState();
}

class _SyllabusLevelAddScreenState extends State<SyllabusLevelAddScreen> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Establish a new level/grade in the Maktab curriculum.',
