...
class MilestoneAddScreen extends StatefulWidget {
  const MilestoneAddScreen({super.key});

  @override
  State<MilestoneAddScreen> createState() => _MilestoneAddScreenState();
}

class _MilestoneAddScreenState extends State<MilestoneAddScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Add Milestone Target Details',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF004D40)),
                ),
                const SizedBox(height: 8),
                const Text(
                  'Create new custom achievement milestones for curriculum.',
